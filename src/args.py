...
def add_flickr_args(parser):
    parser.add_argument('--num_parts', type=int, default=24)
    ...
    parser.add_argument('--K_val_test', type=int, default=7)
    parser.add_argument('--alpha', type=float, default=0.01)
    parser.add_argument('--beta_train', type=float, default=0.7)
    parser.add_argument('--theta', type=float, default=0.5)
...
def get_args():
    ...
    parser.add_argument(
        '--dataset', type=str, choices=['ogbn-products', 'ogbn-arxiv', 'reddit', 'flickr'], default='ogbn-products',
    ...
    if args.dataset == "ogbn-products":
        ...
        add_reddit_args(parser)
    elif args.dataset == "flickr":
        add_flickr_args(parser)
